package com.westangel.commonservice.multimedia.util.qrcode;
...
public class QRCodeUtil {
	...
	public static String encode(String content, String imgPath, String fileName, String destPath, boolean needCompress) throws Exception {
	...
	public static void encode(String content, String imgPath, String destPath) throws Exception {
		QRCodeUtil.encode(content, imgPath, null, destPath, false);
	}
