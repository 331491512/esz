...
import com.westangel.commonservice.sms.service.yuntongxun.SSLHttpClient;
import com.westangel.commonservice.sms.util.EncryptUtil;
import com.westangel.commonservice.sms.util.SysConfig;
...
public abstract class AbsRestClient {
	 ...
	 * callback
	 */
	public abstract HttpResponse callback(String accountSid, String authToken,String appId,String fromClient,String to,String fromSerNum,String toSerNum,String maxallowtime);
	/**
	 * 
	 * @param accountSid
	 * @param authToken
