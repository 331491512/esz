 ...
 *
 */
public class InhospitalNote implements Serializable {
	...
	private String inhospitalWardUuid;
	...
	public String getInhospitalWardUuid() {
		return inhospitalWardUuid;
	}
	public void setInhospitalWardUuid(String inhospitalWardUuid) {
		this.inhospitalWardUuid = inhospitalWardUuid;
	}
	...
	public Integer getAllergyDesc() {
		return allergyDesc;
	}
	public void setAllergyDesc(Integer allergyDesc) {
