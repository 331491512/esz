...
public class MetaController {
	...
	@ResponseBody
	public TMsgResponse<List<TAnesthesiaWayInfo>> getMetaInfoAnesthesiaWayList(String anesthesiaCode,
			String anesthesiaName,Locale locale){
		//设置返回成功代码及提示消息
		TMsgResponse<List<TAnesthesiaWayInfo>> msg=new TMsgResponse<List<TAnesthesiaWayInfo>>();
		msg.respCode=ErrorMessage.SUCCESS.code;
		msg.respMsg=messageSource.getMessage(ErrorMessage.SUCCESS.info, null, locale);
		try{
			msg.result=metaService.queryAnesthesiaWayList(anesthesiaCode,anesthesiaName);
		}catch(Exception e){
			//设置错误代码及提示消息
			msg.respCode=ErrorMessage.E1417.code;
			msg.respMsg=messageSource.getMessage(ErrorMessage.E1417.info, null, locale);
	...
	* @return
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/operation/nature/query", method = RequestMethod.GET)
	public TMsgResponse<List<OperationNature>> queryOperationNature(Locale local) {
		TMsgResponse<List<OperationNature>> tMsgResponse = new TMsgResponse<List<OperationNature>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));

		try {
			tMsgResponse.setResult(metaService.queryOperationNature());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/nnis/operation/incision/clean/query", method = RequestMethod.GET)
	public TMsgResponse<List<NNISOperationIncisionClean>> queryNNISOperationIncisionClean(
			Locale local) {
		TMsgResponse<List<NNISOperationIncisionClean>> tMsgResponse = new TMsgResponse<List<NNISOperationIncisionClean>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));

		try {
			tMsgResponse.setResult(metaService
					.queryNNISOperationIncisionClean());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/nnis/anaesthesia/level/query", method = RequestMethod.GET)
	public TMsgResponse<List<NNISAnaesthesiaLevel>> queryNNISAnaesthesiaLevel(
			Locale local) {
		TMsgResponse<List<NNISAnaesthesiaLevel>> tMsgResponse = new TMsgResponse<List<NNISAnaesthesiaLevel>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));

		try {
			tMsgResponse.setResult(metaService.queryNNISAnaesthesiaLevel());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/nnis/operation/level/query", method = RequestMethod.GET)
	public TMsgResponse<List<NNISOperationLevel>> queryNNISOperationLevel(
			Locale local) {
		TMsgResponse<List<NNISOperationLevel>> tMsgResponse = new TMsgResponse<List<NNISOperationLevel>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));

		try {
			tMsgResponse.setResult(metaService.queryNNISOperationLevel());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/nnis/operation/continued/time/query", method = RequestMethod.GET)
	public TMsgResponse<List<NNISOperationContinuedTime>> queryNNISOperationContinuedTime(
			Locale local) {
		TMsgResponse<List<NNISOperationContinuedTime>> tMsgResponse = new TMsgResponse<List<NNISOperationContinuedTime>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));
		...
		try {
			tMsgResponse.setResult(metaService
					.queryNNISOperationContinuedTime());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
	...
	@ResponseBody
	@RequestMapping(value = "/metainfo/nnis/incision/infected/query", method = RequestMethod.GET)
	public TMsgResponse<List<NNISIncisionInfected>> queryNNISIncisionInfected(
			Locale local) {
		TMsgResponse<List<NNISIncisionInfected>> tMsgResponse = new TMsgResponse<List<NNISIncisionInfected>>();
		tMsgResponse.setRespCode(ErrorMessage.SUCCESS.code);
		tMsgResponse.setRespMsg(messageSource.getMessage(
				ErrorMessage.SUCCESS.info, null, local));

		try {
			tMsgResponse.setResult(metaService.queryNNISIncisionInfected());
		} catch (Exception e) {
			tMsgResponse.setRespCode(ErrorMessage.E1500.code);
			tMsgResponse.setRespMsg(messageSource.getMessage(
					ErrorMessage.E1500.info, null, local));
