...
public class MetaInfoController{
	...
	public TMsgResponse<List<TMetaInfoTreatmentScheme>> getMetaInfoTreatmentSchemeList(Integer treatmentTypeId,String treatmentSchemeName, Locale locale)
	{
		//设置返回成功代码及提示消息
		...
		{
			//查询元数据列表
			msg.result = metaInfoService.getMetaInfoTreatmentSchemeList(treatmentTypeId,treatmentSchemeName);
	...
	public TMsgResponse<List<TMetaInfoIcd9Cm3>> getMetaInfoIcd9Cm3(String key, Locale locale)
	{
		//设置返回成功代码及提示消息
		...
		{
			//查询元数据列表
			msg.result = metaInfoService.getMetaInfoIcd9Cm3(key);
