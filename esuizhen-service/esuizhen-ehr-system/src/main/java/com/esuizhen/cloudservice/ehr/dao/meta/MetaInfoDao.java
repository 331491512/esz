...
public interface MetaInfoDao {
	...
	List<TMetaInfoTreatmentScheme> queryMetaInfoTreatmentSchemeList(@Param("treatmentTypeId") Integer treatmentTypeId, @Param("treatmentSchemeName") String treatmentSchemeName);

	List<TMetaInfoMedicationItem> queryMetaInfoTreatmentSchemeItemList(int treatmentSchemeId);

	List<TMetaInfoIcd9Cm3> queryMetaInfoIcd9Cm3(@Param("key")String key);
	...
	/**
	 * <p>
	 * Title:queryMetaInfoIcdOAll
	 * </p>
	 * <p>
	 * Description:获取所有器官元数据
	 * </p>
	 * 
	 * @author YYCHEN
	 ...
	 * <p>
	 * Title:
	 * queryMetaInfoDiagnosisPeriodizationAll
	 * </p>
	 * <p>
	 * Description:获取诊断分期元数据
	 * </p>
	 * 
	 * @author YYCHEN
	 ...
	 * <p>
	 * Title:
	 * queryMetaInfoTreatmentTypeList
	 * </p>
	 * <p>
	 * Description:查询治疗类型元数据
	 * </p>
	 * 
	 * @author YYCHEN
	 ...
	 * @return
	 */
	List<TMetaInfoTreatmentType> queryMetaInfoTreatmentTypeList(@Param("flag") Integer flag, @Param("showFlag") Integer showFlag,
			@Param("treatmentTypeName") String treatmentTypeName);
	...
	/**
	 * <p>
	 * Title:findMetaInfoDetectionUnit
	 * </p>
	 * <p>
	 * Description:查询检验使用的单位
	 * </p>
	 * 
	 * @author YYCHEN
	...
	Integer findMetaInfoFromDiseaseTypeICD(@Param("diseaseCode") String diseaseCode);
}
