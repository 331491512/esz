...
public class ExamReport {
	...
	private List<ExamReportDetail> examReportSubItemDetailInfos;
    
    public String getPatientSexTxt() {
		return patientSexTxt;
	}

	public void setPatientSexTxt(String patientSexTxt) {
		this.patientSexTxt = patientSexTxt;
	}
	...
	public List<ExamReportDetail> getExamReportSubItemDetailInfos() {
		return examReportSubItemDetailInfos;
	}

	public void setExamReportSubItemDetailInfos(
			List<ExamReportDetail> examReportSubItemDetailInfos) {
		this.examReportSubItemDetailInfos = examReportSubItemDetailInfos;
	}
    ...
    public void setPathologicalSampleType(String pathologicalSampleType) {
        this.pathologicalSampleType = pathologicalSampleType == null ? null : pathologicalSampleType.trim();
    }

    public String getProductionTypeList() {
        return productionTypeList;
    }

    public void setProductionTypeList(String productionTypeList) {
        this.productionTypeList = productionTypeList == null ? null : productionTypeList.trim();
    }
    ...
    public void setProductionTypeDescription(String productionTypeDescription) {
        this.productionTypeDescription = productionTypeDescription == null ? null : productionTypeDescription.trim();
    }
    ...
    public void setPathologicalTissueOrigin(String pathologicalTissueOrigin) {
        this.pathologicalTissueOrigin = pathologicalTissueOrigin == null ? null : pathologicalTissueOrigin.trim();
    }

    public String getSamplePreservationOrganization() {
        return samplePreservationOrganization;
    }

    public void setSamplePreservationOrganization(String samplePreservationOrganization) {
        this.samplePreservationOrganization = samplePreservationOrganization == null ? null : samplePreservationOrganization.trim();
    }
