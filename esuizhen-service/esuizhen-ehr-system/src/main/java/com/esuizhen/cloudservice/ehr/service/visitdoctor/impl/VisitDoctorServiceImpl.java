package com.esuizhen.cloudservice.ehr.service.visitdoctor.impl;
...
public class VisitDoctorServiceImpl implements VisitDoctorService {
	 ...
	 */
	@Override
	public Page<PatientMedicalTreatmentResp> getPatientMedicalTreatmentList(PatientMedicalTreatmentResp resp) {
