...
public interface FollowupConvQuestionSymptomDao {
	
	public List<SymptomsReq> getsymptoms(Long followupConvQuestionId);
	
	public void insert(SymptomsReq symptomsReq);
