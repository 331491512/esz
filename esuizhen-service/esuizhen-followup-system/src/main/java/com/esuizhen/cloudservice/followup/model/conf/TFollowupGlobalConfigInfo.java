...
public class TFollowupGlobalConfigInfo implements Serializable {
	 ...
	 * 确诊时间权限设置
		...
		1：开启
	 */
	private Integer confirmedDateFlag;
	/**
	 * 确诊时间允许修改次数
		默认：1
	 */
	private Integer confirmedDateModCount;
	/**
	 * 确诊时间权限设置
		0：随访主任可修改（包括管理员）（默认）
		1：全部角色均可执行
	 */
	private Integer confirmedDateModPersonFlag;
	...
	public TFollowupGlobalConfigInfo(Integer followupCycle,
			...
			Integer confirmedDateFlag, Integer confirmedDateModCount, Integer confirmedDateModPersonFlag) {
		super();
		...
		this.confirmedDateFlag = confirmedDateFlag;
		this.confirmedDateModCount = confirmedDateModCount;
		this.confirmedDateModPersonFlag = confirmedDateModPersonFlag;
	}
	...
	public Integer getConfirmedDateFlag() {
		return confirmedDateFlag;
	}

	public void setConfirmedDateFlag(Integer confirmedDateFlag) {
		this.confirmedDateFlag = confirmedDateFlag;
	}

	public Integer getConfirmedDateModCount() {
		return confirmedDateModCount;
	}

	public void setConfirmedDateModCount(Integer confirmedDateModCount) {
		this.confirmedDateModCount = confirmedDateModCount;
	}

	public Integer getConfirmedDateModPersonFlag() {
		return confirmedDateModPersonFlag;
	}

	public void setConfirmedDateModPersonFlag(Integer confirmedDateModPersonFlag) {
		this.confirmedDateModPersonFlag = confirmedDateModPersonFlag;
	}
