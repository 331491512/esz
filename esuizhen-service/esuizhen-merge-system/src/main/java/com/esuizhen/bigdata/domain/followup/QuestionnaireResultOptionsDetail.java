 ...
 */
@Entity
@Table(name = "questionnaire_result_options_detail", schema = "followup_db", catalog="")
//@Audited
//@AuditTable(value = "questionnaire_result_options_detail_audit",schema = "followup_db_audit",catalog = "followup_db_audit")
public class QuestionnaireResultOptionsDetail {
    ...
    @Id
    @Column(name = "questionnaireResultOptionId", nullable = false, length = 24)
    public String getQuestionnaireResultOptionId() {
        return questionnaireResultOptionId;
    }

    public void setQuestionnaireResultOptionId(String questionnaireResultOptionId) {
        this.questionnaireResultOptionId = questionnaireResultOptionId;
    }

    @Basic
    @Column(name = "questionnaireResultStemId", nullable = false, length = 24)
    ...
    @Basic
    @Column(name = "questionnaireResultId", nullable = false, length = 24)
    ...
    @Basic
    @Column(name = "questionnaireOptionId", nullable = false, length = 24)
    ...
    @Basic
    @Column(name = "questionnaireStemId", nullable = false, length = 24)
    ...
    @Basic
    @Column(name = "questionnaireId", nullable = false, length = 24)
    ...
    public boolean equals(Object o) {
        ...
        QuestionnaireResultOptionsDetail that = (QuestionnaireResultOptionsDetail) o;
        ...
        if (questionnaireResultOptionId != null ? !questionnaireResultOptionId.equals(that.questionnaireResultOptionId) : that.questionnaireResultOptionId != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = questionnaireResultOptionId != null ? questionnaireResultOptionId.hashCode() : 0;
        result = 31 * result + (questionnaireResultStemId != null ? questionnaireResultStemId.hashCode() : 0);
        result = 31 * result + (questionnaireResultId != null ? questionnaireResultId.hashCode() : 0);
        result = 31 * result + (questionnaireOptionId != null ? questionnaireOptionId.hashCode() : 0);
