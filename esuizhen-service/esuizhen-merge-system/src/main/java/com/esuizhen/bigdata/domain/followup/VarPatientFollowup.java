 ...
 */
@Entity
@Table(name = "var_patient_followup", schema = "followup_db", catalog="")
//@Audited
//@AuditTable(value = "var_patient_followup_audit",schema = "followup_db_audit",catalog = "followup_db_audit")
public class VarPatientFollowup {
    private Integer id;
...
//    private Timestamp smsSendTime;
    ...
    @Basic
    @Column(name = "newContactFlag", nullable = false)
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        VarPatientFollowup that = (VarPatientFollowup) o;
