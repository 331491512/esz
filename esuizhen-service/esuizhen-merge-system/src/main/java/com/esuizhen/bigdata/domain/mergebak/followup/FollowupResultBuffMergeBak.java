 ...
 */
@Entity
@Table(name = "followup_result_buff_merge_bak", schema = "followup_db", catalog="")
public class FollowupResultBuffMergeBak {
    ...
    public boolean equals(Object o) {
        ...
        FollowupResultBuffMergeBak that = (FollowupResultBuffMergeBak) o;
