 ...
 */
@Entity
@Table(name = "meta_professional_rank", schema = "user_db" , catalog="")
//@Audited
//@AuditTable(value = "meta_professional_rank_audit",schema = "user_db_audit",catalog = "user_db_audit")
public class MetaProfessionalRank {
    ...
    public boolean equals(Object o) {
        ...
        MetaProfessionalRank that = (MetaProfessionalRank) o;
