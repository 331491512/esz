 ...
 */
@Entity
@Table(name = "u_patient", schema = "user_db", catalog = "")
//@Audited//(withModifiedFlag = true)
//@AuditTable(value = "u_patient_audit", schema = "user_db_audit", catalog = "user_db_audit")
public class UPatient implements Serializable {
     ...
     * 数据库中的lastAttendingTime 是合并脚本临时使用的字段，就不使用了，我直接计算即可。
     */
    ...
    /**
     * `patientType` int(2) DEFAULT '1' COMMENT '患者类型。1：普通（默认）；2：特病; -1: 被合并掉的疑似重复患者(类软删除)',
     */
    ...
    public UPatient(long patientId, String trueName) {
    ...
    public boolean equals(Object o) {
        ...
        UPatient uPatient = (UPatient) o;

        if (patientId != uPatient.patientId) return false;
        if (auditState != uPatient.auditState) return false;
        if (hasVisibleMedicalRecord != uPatient.hasVisibleMedicalRecord) return false;
        if (liveStatus != uPatient.liveStatus) return false;
        if (followupFlag != uPatient.followupFlag) return false;
        if (patientNo != null ? !patientNo.equals(uPatient.patientNo) : uPatient.patientNo != null) return false;
        if (uuid != null ? !uuid.equals(uPatient.uuid) : uPatient.uuid != null) return false;
        if (syncFlag != null ? !syncFlag.equals(uPatient.syncFlag) : uPatient.syncFlag != null) return false;
        if (mobile != null ? !mobile.equals(uPatient.mobile) : uPatient.mobile != null) return false;
        if (trueName != null ? !trueName.equals(uPatient.trueName) : uPatient.trueName != null) return false;
        if (preTrueName != null ? !preTrueName.equals(uPatient.preTrueName) : uPatient.preTrueName != null)
            return false;
        if (auditRemark != null ? !auditRemark.equals(uPatient.auditRemark) : uPatient.auditRemark != null)
            return false;
        if (nickName != null ? !nickName.equals(uPatient.nickName) : uPatient.nickName != null) return false;
        if (sex != null ? !sex.equals(uPatient.sex) : uPatient.sex != null) return false;
        if (birthDate != null ? !birthDate.equals(uPatient.birthDate) : uPatient.birthDate != null) return false;
        if (userPictureUrl != null ? !userPictureUrl.equals(uPatient.userPictureUrl) : uPatient.userPictureUrl != null)
            return false;
        if (patientRelation != null ? !patientRelation.equals(uPatient.patientRelation) : uPatient.patientRelation != null)
            return false;
        if (familyName != null ? !familyName.equals(uPatient.familyName) : uPatient.familyName != null) return false;
        if (familyPhone != null ? !familyPhone.equals(uPatient.familyPhone) : uPatient.familyPhone != null)
            return false;
        if (deathDate != null ? !deathDate.equals(uPatient.deathDate) : uPatient.deathDate != null) return false;
        if (causeOfDeath != null ? !causeOfDeath.equals(uPatient.causeOfDeath) : uPatient.causeOfDeath != null)
            return false;
        if (isInHospitalDeath != null ? !isInHospitalDeath.equals(uPatient.isInHospitalDeath) : uPatient.isInHospitalDeath != null)
            return false;
        if (isTumourDeath != null ? !isTumourDeath.equals(uPatient.isTumourDeath) : uPatient.isTumourDeath != null)
            return false;
        if (bloodType != null ? !bloodType.equals(uPatient.bloodType) : uPatient.bloodType != null) return false;
        if (bloodTypeRh != null ? !bloodTypeRh.equals(uPatient.bloodTypeRh) : uPatient.bloodTypeRh != null)
            return false;
        if (bodyHeight != null ? !bodyHeight.equals(uPatient.bodyHeight) : uPatient.bodyHeight != null) return false;
        if (disabilityStatus != null ? !disabilityStatus.equals(uPatient.disabilityStatus) : uPatient.disabilityStatus != null)
            return false;
        if (geneticDiseaseHistory != null ? !geneticDiseaseHistory.equals(uPatient.geneticDiseaseHistory) : uPatient.geneticDiseaseHistory != null)
            return false;
        if (drugAllergyHistory != null ? !drugAllergyHistory.equals(uPatient.drugAllergyHistory) : uPatient.drugAllergyHistory != null)
            return false;
        if (medicalPayType != null ? !medicalPayType.equals(uPatient.medicalPayType) : uPatient.medicalPayType != null)
            return false;
        if (sourceDiagnosis != null ? !sourceDiagnosis.equals(uPatient.sourceDiagnosis) : uPatient.sourceDiagnosis != null)
            return false;
        if (sourceDiagnosis2 != null ? !sourceDiagnosis2.equals(uPatient.sourceDiagnosis2) : uPatient.sourceDiagnosis2 != null)
            return false;
        if (sourceDiagnosis3 != null ? !sourceDiagnosis3.equals(uPatient.sourceDiagnosis3) : uPatient.sourceDiagnosis3 != null)
            return false;
        if (sourceDiseaseCode != null ? !sourceDiseaseCode.equals(uPatient.sourceDiseaseCode) : uPatient.sourceDiseaseCode != null)
            return false;
        if (sourceDiseaseCode2 != null ? !sourceDiseaseCode2.equals(uPatient.sourceDiseaseCode2) : uPatient.sourceDiseaseCode2 != null)
            return false;
        if (sourceDiseaseCode3 != null ? !sourceDiseaseCode3.equals(uPatient.sourceDiseaseCode3) : uPatient.sourceDiseaseCode3 != null)
            return false;
        if (sourceDiseaseTypeId != null ? !sourceDiseaseTypeId.equals(uPatient.sourceDiseaseTypeId) : uPatient.sourceDiseaseTypeId != null)
            return false;
        if (sourceDiseaseTypeId2 != null ? !sourceDiseaseTypeId2.equals(uPatient.sourceDiseaseTypeId2) : uPatient.sourceDiseaseTypeId2 != null)
            return false;
        if (sourceDiseaseTypeId3 != null ? !sourceDiseaseTypeId3.equals(uPatient.sourceDiseaseTypeId3) : uPatient.sourceDiseaseTypeId3 != null)
            return false;
        if (icdDiseaseTypeId != null ? !icdDiseaseTypeId.equals(uPatient.icdDiseaseTypeId) : uPatient.icdDiseaseTypeId != null)
            return false;
        if (diagnosisType != null ? !diagnosisType.equals(uPatient.diagnosisType) : uPatient.diagnosisType != null)
            return false;
        if (sourceTumorFlag != null ? !sourceTumorFlag.equals(uPatient.sourceTumorFlag) : uPatient.sourceTumorFlag != null)
            return false;
        if (sourceDiseaseTypeName != null ? !sourceDiseaseTypeName.equals(uPatient.sourceDiseaseTypeName) : uPatient.sourceDiseaseTypeName != null)
            return false;
        if (sourceDiseaseTypeName2 != null ? !sourceDiseaseTypeName2.equals(uPatient.sourceDiseaseTypeName2) : uPatient.sourceDiseaseTypeName2 != null)
            return false;
        if (sourceDiseaseTypeName3 != null ? !sourceDiseaseTypeName3.equals(uPatient.sourceDiseaseTypeName3) : uPatient.sourceDiseaseTypeName3 != null)
            return false;
        if (icdDiseaseTypeId2 != null ? !icdDiseaseTypeId2.equals(uPatient.icdDiseaseTypeId2) : uPatient.icdDiseaseTypeId2 != null)
            return false;
        if (diagnosisType2 != null ? !diagnosisType2.equals(uPatient.diagnosisType2) : uPatient.diagnosisType2 != null)
            return false;
        if (confirmedDate != null ? !confirmedDate.equals(uPatient.confirmedDate) : uPatient.confirmedDate != null)
            return false;
        if (confirmedDate2 != null ? !confirmedDate2.equals(uPatient.confirmedDate2) : uPatient.confirmedDate2 != null)
            return false;
        if (confirmedDate3 != null ? !confirmedDate3.equals(uPatient.confirmedDate3) : uPatient.confirmedDate3 != null)
            return false;
        if (sourceTumorFlag2 != null ? !sourceTumorFlag2.equals(uPatient.sourceTumorFlag2) : uPatient.sourceTumorFlag2 != null)
            return false;
        if (confirmedAge != null ? !confirmedAge.equals(uPatient.confirmedAge) : uPatient.confirmedAge != null)
            return false;
        if (diagnosisId != null ? !diagnosisId.equals(uPatient.diagnosisId) : uPatient.diagnosisId != null)
            return false;
        if (sourcePathologyDiagnosis != null ? !sourcePathologyDiagnosis.equals(uPatient.sourcePathologyDiagnosis) : uPatient.sourcePathologyDiagnosis != null)
            return false;
        if (sourcePathologyDiseaseCode != null ? !sourcePathologyDiseaseCode.equals(uPatient.sourcePathologyDiseaseCode) : uPatient.sourcePathologyDiseaseCode != null)
            return false;
        if (confirmedAge2 != null ? !confirmedAge2.equals(uPatient.confirmedAge2) : uPatient.confirmedAge2 != null)
            return false;
        if (diagnosisId2 != null ? !diagnosisId2.equals(uPatient.diagnosisId2) : uPatient.diagnosisId2 != null)
            return false;
        if (inhospitalId != null ? !inhospitalId.equals(uPatient.inhospitalId) : uPatient.inhospitalId != null)
            return false;
        if (inhospitalId2 != null ? !inhospitalId2.equals(uPatient.inhospitalId2) : uPatient.inhospitalId2 != null)
            return false;
        if (sourcePathologyDiagnosis2 != null ? !sourcePathologyDiagnosis2.equals(uPatient.sourcePathologyDiagnosis2) : uPatient.sourcePathologyDiagnosis2 != null)
            return false;
        if (sourcePathologyDiseaseCode2 != null ? !sourcePathologyDiseaseCode2.equals(uPatient.sourcePathologyDiseaseCode2) : uPatient.sourcePathologyDiseaseCode2 != null)
            return false;
        if (secondaryDiagnosis != null ? !secondaryDiagnosis.equals(uPatient.secondaryDiagnosis) : uPatient.secondaryDiagnosis != null)
            return false;
        if (secondaryDiseaseCode != null ? !secondaryDiseaseCode.equals(uPatient.secondaryDiseaseCode) : uPatient.secondaryDiseaseCode != null)
            return false;
        if (secondaryPathologyDiagnosis != null ? !secondaryPathologyDiagnosis.equals(uPatient.secondaryPathologyDiagnosis) : uPatient.secondaryPathologyDiagnosis != null)
            return false;
        if (secondaryPathologyDiseaseCode != null ? !secondaryPathologyDiseaseCode.equals(uPatient.secondaryPathologyDiseaseCode) : uPatient.secondaryPathologyDiseaseCode != null)
            return false;
        if (attendingDoctor != null ? !attendingDoctor.equals(uPatient.attendingDoctor) : uPatient.attendingDoctor != null)
            return false;
        if (inchargeDoctor != null ? !inchargeDoctor.equals(uPatient.inchargeDoctor) : uPatient.inchargeDoctor != null)
            return false;
        if (lostFollowupCause != null ? !lostFollowupCause.equals(uPatient.lostFollowupCause) : uPatient.lostFollowupCause != null)
            return false;
        if (lostFollowupCauseResultValue != null ? !lostFollowupCauseResultValue.equals(uPatient.lostFollowupCauseResultValue) : uPatient.lostFollowupCauseResultValue != null)
            return false;
        if (lostFollowupTime != null ? !lostFollowupTime.equals(uPatient.lostFollowupTime) : uPatient.lostFollowupTime != null)
            return false;
        if (trueNameDataFlag != null ? !trueNameDataFlag.equals(uPatient.trueNameDataFlag) : uPatient.trueNameDataFlag != null)
            return false;
        if (diseaseCodeDataFlag != null ? !diseaseCodeDataFlag.equals(uPatient.diseaseCodeDataFlag) : uPatient.diseaseCodeDataFlag != null)
            return false;
        if (identificationDataFlag != null ? !identificationDataFlag.equals(uPatient.identificationDataFlag) : uPatient.identificationDataFlag != null)
            return false;
        if (contactDataFlag != null ? !contactDataFlag.equals(uPatient.contactDataFlag) : uPatient.contactDataFlag != null)
            return false;
        if (patientNoDataFlag != null ? !patientNoDataFlag.equals(uPatient.patientNoDataFlag) : uPatient.patientNoDataFlag != null)
            return false;
        if (diagnosisDataFlag != null ? !diagnosisDataFlag.equals(uPatient.diagnosisDataFlag) : uPatient.diagnosisDataFlag != null)
            return false;
        if (diseaseTypeDataFlag != null ? !diseaseTypeDataFlag.equals(uPatient.diseaseTypeDataFlag) : uPatient.diseaseTypeDataFlag != null)
            return false;
        if (dataFlagUpdateTime != null ? !dataFlagUpdateTime.equals(uPatient.dataFlagUpdateTime) : uPatient.dataFlagUpdateTime != null)
            return false;
        if (createTime != null ? !createTime.equals(uPatient.createTime) : uPatient.createTime != null) return false;
        if (updateTime != null ? !updateTime.equals(uPatient.updateTime) : uPatient.updateTime != null) return false;
        if (codePerson != null ? !codePerson.equals(uPatient.codePerson) : uPatient.codePerson != null) return false;
        if (codePersonName != null ? !codePersonName.equals(uPatient.codePersonName) : uPatient.codePersonName != null)
            return false;
        if (handleFlag != null ? !handleFlag.equals(uPatient.handleFlag) : uPatient.handleFlag != null) return false;
        if (outPatientFlag != null ? !outPatientFlag.equals(uPatient.outPatientFlag) : uPatient.outPatientFlag != null)
            return false;
        if (patientType != null ? !patientType.equals(uPatient.patientType) : uPatient.patientType != null)
            return false;
        if (clinicNo != null ? !clinicNo.equals(uPatient.clinicNo) : uPatient.clinicNo != null) return false;
        if (medicareCardNo != null ? !medicareCardNo.equals(uPatient.medicareCardNo) : uPatient.medicareCardNo != null)
            return false;
        if (medicalCareAreaId != null ? !medicalCareAreaId.equals(uPatient.medicalCareAreaId) : uPatient.medicalCareAreaId != null)
            return false;
        if (medicalCarePlace != null ? !medicalCarePlace.equals(uPatient.medicalCarePlace) : uPatient.medicalCarePlace != null)
            return false;
        if (famZipCode != null ? !famZipCode.equals(uPatient.famZipCode) : uPatient.famZipCode != null) return false;
        if (rawCreateTime != null ? !rawCreateTime.equals(uPatient.rawCreateTime) : uPatient.rawCreateTime != null)
            return false;
    ...
    @ManyToOne
    @JoinColumn(name = "userId", referencedColumnName = "userId", nullable = false, insertable = false, updatable = false, foreignKey = @ForeignKey(name = "u_patient_ibfk_1"))
