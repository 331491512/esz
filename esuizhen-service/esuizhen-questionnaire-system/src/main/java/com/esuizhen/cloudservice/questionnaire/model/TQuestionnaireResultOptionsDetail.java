...
public class TQuestionnaireResultOptionsDetail{
	/**
	 * 主键。
	 */
	 ...
	 * 子选项列表
	 */
	private List<TQuestionnaireResultOptionsDetail> questionOptions;
	...
	public List<TQuestionnaireResultOptionsDetail> getQuestionOptions()
	{
		return questionOptions;
	}

	public void setQuestionOptions(List<TQuestionnaireResultOptionsDetail> questionOptions)
	{
