...
public interface ClinicMedicalNoteDao {

	List<LinkedHashMap> getBatchSyncClinicMedicalNote(@Param("detailInfo")TBatchDetailInfo detailInfo);

	void updateClinicMedicalNoteSyncflag(@Param("clinicMedicalIds") String clinicMedicalIds);
