...
public interface FollowupResultBuffDao {

	List<LinkedHashMap> getBatchSyncFollowupResultBuff(@Param("detailInfo") TBatchDetailInfo detailInfo);

	void updateFollowupResultBuffSyncflag(@Param("followupResultBuffIds") String followupResultBuffIds);
