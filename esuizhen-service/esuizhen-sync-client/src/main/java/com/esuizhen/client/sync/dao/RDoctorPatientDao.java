...
public interface RDoctorPatientDao {

	List<LinkedHashMap> getBatchSyncRDoctorPatient(@Param("detailInfo") TBatchDetailInfo detailInfo);

	void updateRDoctorPatientSyncflag(@Param("ids") String ids);
