...
/**
 * Created by Nidan on 2017年03月24 下午 16:56
 */
public class FollowupResultBuffRes {
    ...
    public void setFollowupResultBuffId(String followupResultBuffId) {
        this.followupResultBuffId = followupResultBuffId == null ? null : followupResultBuffId.trim();
    }
	...
	public TBatchDataResultInfo createResultInfo(){
        ...
        resultInfo.setResultId(this.followupResultBuffId);
        return resultInfo;
    }
